 ...
 * @generated
 */
public class SimpleFMSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case SimpleFMPackage.FEATURE_MODEL: {
				FeatureModel featureModel = (FeatureModel)theEObject;
				T result = caseFeatureModel(featureModel);
				if (result == null) result = caseFeatureContainer(featureModel);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleFMPackage.FEATURE_CONTAINER: {
				FeatureContainer featureContainer = (FeatureContainer)theEObject;
				T result = caseFeatureContainer(featureContainer);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleFMPackage.FEATURE: {
				Feature feature = (Feature)theEObject;
				T result = caseFeature(feature);
				if (result == null) result = caseFeatureContainer(feature);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleFMPackage.CONSTRAINT: {
				Constraint constraint = (Constraint)theEObject;
				T result = caseConstraint(constraint);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleFMPackage.FEATURE_EXISTS: {
				FeatureExists featureExists = (FeatureExists)theEObject;
				T result = caseFeatureExists(featureExists);
				if (result == null) result = caseConstraint(featureExists);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleFMPackage.BINARY_CONSTRAINT: {
			...
			case SimpleFMPackage.AND_EXPR: {
				AndExpr andExpr = (AndExpr)theEObject;
				T result = caseAndExpr(andExpr);
				if (result == null) result = caseBinaryConstraint(andExpr);
				if (result == null) result = caseConstraint(andExpr);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleFMPackage.OR_EXPR: {
				OrExpr orExpr = (OrExpr)theEObject;
				T result = caseOrExpr(orExpr);
				if (result == null) result = caseBinaryConstraint(orExpr);
				if (result == null) result = caseConstraint(orExpr);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case SimpleFMPackage.IMPLIES_EXPR: {
				ImpliesExpr impliesExpr = (ImpliesExpr)theEObject;
				T result = caseImpliesExpr(impliesExpr);
				if (result == null) result = caseBinaryConstraint(impliesExpr);
				if (result == null) result = caseConstraint(impliesExpr);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Feature Exists</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Feature Exists</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseFeatureExists(FeatureExists object) {
		return null;
	}
