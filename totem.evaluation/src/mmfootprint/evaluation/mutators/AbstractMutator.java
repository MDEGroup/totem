package mmfootprint.evaluation.mutators;
...
public abstract class AbstractMutator {
	 ...
	 */
	public abstract void mutate (MMResource metamodel, String outputFolder);
	 ...
	 * @param outputFolder
	 */
	protected void save (MMResource metamodel, String outputFolder) {
		String file = null;
		try {
